...
The resume page embeds a pre-generated PDF rendered via pdf.js. Run
this after editing data/resume.json or source.html:

    DEPLOYMENT_TYPE=DEBUG python scripts/gen_resume_pdf.py

Uses Playwright's page.pdf() with the source's print CSS, which flows
content naturally across A4 pages (page-break-inside: avoid) and keeps
the text as real selectable PDF text — not images.
"""
...
def main() -> None:
    ...
    with sync_playwright() as p:
        ...
        # page.pdf() applies @media print, producing real selectable text.
